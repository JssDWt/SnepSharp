...
{
    /// <summary>
    /// Snep not implemented response. The server does not support the functionality required to fulfill the request. 
    /// For example when a request code is not recognized.
    /// </summary>
    internal class SnepNotImplementedResponse : SnepResponse
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="T:Snep.SnepNotImplementedResponse"/> class.
        /// </summary>
